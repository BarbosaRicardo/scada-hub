...
const events = [
  ...
  // ── PID CONTROLLERS ───────────────────────────────────────────────────────────
  { course: 'pid', provider: 'Control Station', title: 'Process Control & PID Tuning Workshop (June)', format: 'online', start_date: '2026-06-02', end_date: '2026-06-05', url: 'https://controlstation.com/process-control-and-pid-tuning-training/', is_cert: false, cert_name: null },
  { course: 'pid', provider: 'Control Station', title: 'Process Control & PID Tuning Workshop (September)', format: 'online', start_date: '2026-09-01', end_date: '2026-09-04', url: 'https://controlstation.com/process-control-and-pid-tuning-training/', is_cert: false, cert_name: null },
  ...
  { course: 'ignition', provider: 'Inductive Automation', title: 'Ignition Core Certification', format: 'self-paced', start_date: null, end_date: null, url: 'https://inductiveautomation.com/training/certification-tests', is_cert: true, cert_name: 'Ignition Core' },
  { course: 'ignition', provider: 'Inductive Automation', title: 'Ignition Gold Certification (requires Core)', format: 'self-paced', start_date: null, end_date: null, url: 'https://inductiveautomation.com/training/certification-tests', is_cert: true, cert_name: 'Ignition Gold' },
