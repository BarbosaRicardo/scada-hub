...
const GUIDES = [
  ...
  },
  {
    ...
    desc: 'Packet capture for SCADA engineers. BPF filters, TCP analysis, DNP3/Modbus decode, tshark CLI, and WCA cert prep.',
    chapters: 10,
    questions: 150,
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {[
            ...
            { value: '9', label: 'LaTeX PDFs' },
            { value: '9', label: 'GitHub Pages Sites' },
          ].map((stat) => (
            <div
              key={stat.label}
